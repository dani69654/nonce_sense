...
exports.computeWorkersData = void 0;
const UNITS = {
    T: 1e12,
    G: 1e9,
    M: 1e6,
...
const convertHashrate = (hashrateStr) => {
    const match = hashrateStr.match(/^([\d.]+)([TGMK])$/);
    if (!match)
        return parseFloat(hashrateStr);
    const [, numStr, unit] = match;
    return parseFloat(numStr) * UNITS[unit];
};
const computeWorkersData = (data) => {
...
exports.computeWorkersData = computeWorkersData;
